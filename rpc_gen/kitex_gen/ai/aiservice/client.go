...
type Client interface {
	Chat(ctx context.Context, Req *ai.AiReq, callOptions ...callopt.Option) (stream AiService_ChatClient, err error)
}

// StreamClient is designed to provide Interface for Streaming APIs.
type StreamClient interface {
	Chat(ctx context.Context, Req *ai.AiReq, callOptions ...streamcall.Option) (stream AiService_ChatClient, err error)
}

type AiService_ChatClient interface {
	streaming.Stream
	Recv() (*ai.AiResp, error)
}
...
func (p *kAiServiceClient) Chat(ctx context.Context, Req *ai.AiReq, callOptions ...callopt.Option) (stream AiService_ChatClient, err error) {
...
func (p *kAiServiceStreamClient) Chat(ctx context.Context, Req *ai.AiReq, callOptions ...streamcall.Option) (stream AiService_ChatClient, err error) {
